...
<title>Parirakshan Gallery</title>
    	...
    	<section id="main-content">
    		<div class="wrap main-content-wrap">
                ...
                <div class="clear separator"></div><!-- separator div -->           		
					...
					{ ?>
                        <div class="portfolio-wrap-col-gal">
                        	<a href='gallery-images.php?cat_id=<?=$row['cat_id']?>'><img src='admin/upload_cat/<?=$row['pic'];?>' alt="Parirakshan Organica" /></a>
                        	<a href="organic-farming-overview.html"><h4><?=$row['cat_name']?></h4></a>

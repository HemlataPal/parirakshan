            	...
            	<div class="col-24">
                	<div id="header-content">                    	
                        <div id="custom-header-content">
                             ...
                             <!--<a href="contact-us.php"><strong>Delhi NCR:</strong> +91-9999384154, +91-8744841140 &nbsp;  <strong>Uttrakhand:</strong> +91-9456176331</a>--> &nbsp;
                ...
                <div class="col-24">
                	<nav id="navigation">
                        	<ul id="mobile-menu" class="sf-menu">
                                ...
                                <li><a href="whats-going.html">What's Going on?</a></li>-->
    ...
    <div id="page-middle">    
    	<section id="main-content">
    		<div class="wrap main-content-wrap">  
                ...
                <div id="portfolio-wrap" class="portfolio-wrap-col-4">
                
                	<!-- end .col-6 .portfolio-item -->
                    
             
                                      <?php 
			$cat_id=$_GET['cat_id'];
					$query="select * from gallary where cat_id=".$cat_id;
					$result= mysql_query($query);
					while($row= mysql_fetch_array($result))
					{ ?>
                           <div class="col-6 portfolio-item" data-type="vector web-design" data-id="id-1">
                    	<div class="portfolio-item-bg">
                        	
                            <div class="portfolio-item-thumb">
                            	<div class="post-thumb align-none">
                    				<div class="zoom-img">
                    					<a href='admin/upload_images/<?=$row['pic'];?>' data-rel="prettyPhoto[gallery_id_2]">
                    						<img class="img img-opacity" src='admin/upload_images/<?=$row['pic'];?>' alt="Parirakshan Gallery" />
                    					</a> 
                                        	</div><!-- end .zoom-img -->                            
                    			</div><!-- end .post-thumb align-none-->
                            </div><!-- end .portfolio-item-thumb -->                            
                        </div><!-- end .portfolio-item-bg -->      
                	</div><!-- end .col-6 .portfolio-item -->  

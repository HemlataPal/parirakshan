    		...
    		<div class="wrap main-content-wrap">
            	<div class="col-12">                	
                    <article class="article page-article">
                        <h4 class="title1">Be a part of us</h4>
                      <?php 
...
if ( mail )
          ...
          echo "<strong>";
          echo "Thank You  for writing in, we will get back to you as soon as possible.";
          echo "</font>";
          } else {
...
?>   
                        	...
                        	<fieldset>
                                ...
                                <div class="filed-group">
                              	...
                              	<div class="filed-group filed-group-button">
                               		<input class="submit form-button-big contactform-button" type="submit" value="Join Us"/>
                                </div>
                ...
                <aside class="col-12 sidebar sidebar-right">
                    ...
                    <div class="widget">
                        ...
                        <img src="imgs/join-form.jpg" style="border-radius:50%">
                        <br/><br/>
